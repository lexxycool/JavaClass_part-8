...
public class ExceptionsLecture {
	...
	public static void main(String[] args) {
		...
		try {  // hey! let's try this code and see if we throw an exception
			...
			// If an ArrayIndexOutOfBoundsException is thrown, flow of control will be here
		...
		System.out.println("After the call to doSomethingDangerous");
		...
		} catch (Exception e){  // Exception is a parent of the NumberFormatException, this will catch error
		...
		try {
			...
			System.out.println(numberOfGuests + " guests for " + nights + " nights doesn't make sense!");
			System.out.println(e.getMessage());  // print out the message from the throw in the method
		}
		...
		try {
			...
			System.out.println("Unfortunately, you cannot withdraw more money that you have in the bank...");
			System.out.println("The request would overdraw your account by " + e.getOverdraftAmount());
		}
		...
		try {
			doSomethingDangerous(); // throws an ArrayIndexOutOfBoundsException
		} catch (ArrayIndexOutOfBoundsException e) {  // code for more specific exception first
